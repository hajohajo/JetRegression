...
def create_model(model_name, Ccands_shape, Ncands_shape, Pcands_shape, Globals_shape):
    if model_name is 'DeepJet':
        chg_inp = Input(shape=(Ccands_shape[1], Ccands_shape[2]), name='Charged input')
        ...
        neu_inp = Input(shape=(Ncands_shape[1], Ncands_shape[2]), name='Neutral input')
        ...
        pho_inp = Input(shape=(Pcands_shape[1], Pcands_shape[2]), name='photon input')
